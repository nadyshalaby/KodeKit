...
<?php if ($this->_tpl_vars['classes']): ?>
    <div class="contents">
        ...
        <h2>Classes:</h2>
        <?php
        if (isset($this->_sections['classes']))
        ...
        if ($this->_sections['classes']['show']):
            ...
            for ($this->_sections['classes']['index'] = $this->_sections['classes']['start'], $this->_sections['classes']['iteration'] = 1; $this->_sections['classes']['iteration'] <= $this->_sections['classes']['total']; $this->_sections['classes']['index'] += $this->_sections['classes']['step'], $this->_sections['classes']['iteration'] ++):
