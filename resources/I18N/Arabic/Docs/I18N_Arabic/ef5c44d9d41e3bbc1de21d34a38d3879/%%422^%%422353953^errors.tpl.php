...
if ($this->_sections['files']['show']):
    ...
    for ($this->_sections['files']['index'] = $this->_sections['files']['start'], $this->_sections['files']['iteration'] = 1; $this->_sections['files']['iteration'] <= $this->_sections['files']['total']; $this->_sections['files']['index'] += $this->_sections['files']['step'], $this->_sections['files']['iteration'] ++):
...
?>
<?php
if (count($_from = (array) $this->_tpl_vars['all'])):
    foreach ($_from as $this->_tpl_vars['file'] => $this->_tpl_vars['issues']):
        ...
        <?php if (count($this->_tpl_vars['issues']['warnings'])): ?>
            <h2>Warnings:</h2><br>
            <?php
            if (isset($this->_sections['warnings']))
            ...
            if ($this->_sections['warnings']['show']):
                ...
                for ($this->_sections['warnings']['index'] = $this->_sections['warnings']['start'], $this->_sections['warnings']['iteration'] = 1; $this->_sections['warnings']['iteration'] <= $this->_sections['warnings']['total']; $this->_sections['warnings']['index'] += $this->_sections['warnings']['step'], $this->_sections['warnings']['iteration'] ++):
        ...
        <?php if (count($this->_tpl_vars['issues']['errors'])): ?>
            <h2>Errors:</h2><br>
            <?php
            if (isset($this->_sections['errors']))
            ...
            if ($this->_sections['errors']['show']):
                ...
                for ($this->_sections['errors']['index'] = $this->_sections['errors']['start'], $this->_sections['errors']['iteration'] = 1; $this->_sections['errors']['iteration'] <= $this->_sections['errors']['total']; $this->_sections['errors']['index'] += $this->_sections['errors']['step'], $this->_sections['errors']['iteration'] ++):
