        ...
        <table border="0" cellspacing="0" cellpadding="0" height="48" width="100%">
            ...
            <tr>
                <td class="header_menu">
                    ...
                    <?php
                    if (count($_from = (array) $this->_tpl_vars['packageindex'])):
                ...
                <td width="200" class="menu">
                        ...
                        <div id="ric">
                            ...
                            if ($this->_sections['ric']['show']):
                                ...
                                for ($this->_sections['ric']['index'] = $this->_sections['ric']['start'], $this->_sections['ric']['iteration'] = 1; $this->_sections['ric']['iteration'] <= $this->_sections['ric']['total']; $this->_sections['ric']['index'] += $this->_sections['ric']['step'], $this->_sections['ric']['iteration'] ++):
...
<?php endif; ?>
                    ...
                    <b>Packages:</b><br />
                    <?php
                    if (isset($this->_sections['packagelist']))
                    ...
                    if ($this->_sections['packagelist']['show']):
                        ...
                        for ($this->_sections['packagelist']['index'] = $this->_sections['packagelist']['start'], $this->_sections['packagelist']['iteration'] = 1; $this->_sections['packagelist']['iteration'] <= $this->_sections['packagelist']['total']; $this->_sections['packagelist']['index'] += $this->_sections['packagelist']['step'], $this->_sections['packagelist']['iteration'] ++):
                    ...
                    <?php if ($this->_tpl_vars['tutorials']): ?>
                        ...
                        <?php if ($this->_tpl_vars['tutorials']['pkg']): ?>
                            ...
                            if ($this->_sections['ext']['show']):
                                ...
                                for ($this->_sections['ext']['index'] = $this->_sections['ext']['start'], $this->_sections['ext']['iteration'] = 1; $this->_sections['ext']['iteration'] <= $this->_sections['ext']['total']; $this->_sections['ext']['index'] += $this->_sections['ext']['step'], $this->_sections['ext']['iteration'] ++):
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <?php if (!$this->_tpl_vars['noleftindex']): echo smarty_function_assign(array('var' => 'noleftindex', 'value' => false), $this);
                    endif;
                    ?>
...
<?php if (!$this->_tpl_vars['hasel']): echo smarty_function_assign(array('var' => 'hasel', 'value' => false), $this);
endif;
?>
